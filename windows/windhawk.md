...
Windows 11 Taskbar Styler is set to the **Rosé Pine** community theme. Muted purples and dark base, no bright accents.

## Install

1. Download [Windhawk](https://windhawk.net)
2. Open → Explore → search each mod by name → Install
3. For Taskbar Styler: Details → Settings → paste Rosé Pine theme JSON from the mod's community tab
